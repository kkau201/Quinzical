...
(proclaim_voice
 ...
 '((language english)
   ...
   (dialect newzealand)
   (description
    "This voice provides an New Zealand English male voice using a
     residual excited LPC diphone synthesis method.  It uses 
     the Oxford Lexicon pronunciations, with 1500 commonly used Maori words added.  
	The remaining features are based on the KAL voice features. This means the following.
	Prosodic phrasing is provided 
